                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div data-date-minviewmode="months" data-date-viewmode="years"
                                                ...
                                                <input type="text" id="startDate" class="form-control dpd1 AQForm tc" name="from">
                                                <span class="input-group-addon">到</span>
                                                <input type="text" id="endDate" class="form-control dpd2 AQForm tc" name="to">
                                            </div>
                                        </td>
                                        <td>&nbsp;&nbsp;或&nbsp;&nbsp;</td>
                                        <td>
                                            <input type="text" id="interval" class="form-control AQForm" placeholder="间隔天数">
                                        </td>
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    function search() {
        ...
        mapDataIntervalCondition = $('#interval').val();
        findWorldMap();
    }
    ...
    function findWorldMap() {
        $.post('${pageContext.request.contextPath}/oieWorldRegion/epidemicRecentOutbreakRegion.do', {
            ...
            if (data!==null){
                ...
                option.series[0].data = data.mapDataList;
            }
