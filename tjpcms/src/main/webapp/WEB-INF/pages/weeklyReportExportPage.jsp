            ...
            <div class="wrapper">
                ...
                <div class="wrapper" style="display: none">
                    ...
                    <form style="display: none" id="uploadData">
                        <input name="startDateCondition" value="" id="in1">
                        <input name="svgString" value="" id="in2">
                        <input name="svgDiseaseDetailBar" value="" id="in3">
                        <input name="svgDiseaseHistoryBar" value="" id="in4">
                        <input name="svgReportReasonPie" value="" id="in5">
                    </form>
                </div>
...
<script type="application/javascript">
    ...
    <script type="text/javascript">
        ...
        function uploadSvgString() {
            ...
            var svg_diseaseDetail_bar = chart_diseaseDetail_bar!=null?chart_diseaseDetail_bar.getSVG():'';
        ...
        function changeProcessBar(percent) {
            ...
            processDiv.append('' +
                ...
                '<div id ="processBar" style="width: '+percent+'%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="45" role="progressbar" class="progress-bar progress-bar-success">' +
        ...
        function findDiseaseClassData(startDateCondition) {
            $.post('${pageContext.request.contextPath}/weeklyReportExport/findDiseaseClassData.do', {
        ...
        function findDiseaseDetailData(startDateCondition) {
            $.post('${pageContext.request.contextPath}/weeklyReportExport/findDiseaseDetailData.do', {
                    'startDateCondition':startDateCondition
                },
                function (data) {
                    if (data!=null&&data.length>0){
        ...
        function findContinentDiseaseHistoryData(startDateCondition) {
            $.post('${pageContext.request.contextPath}/weeklyReportExport/findContinentDiseaseHistoryData.do', {
                    'startDateCondition':startDateCondition
                },
                function (data) {
                    if (data!=null&&data.length>0){
        ...
        function findReportReasonData(startDateCondition) {
            $.post('${pageContext.request.contextPath}/weeklyReportExport/findReportReasonData.do', {
                    'startDateCondition':startDateCondition
                },
                function (data) {
                    if (data!=null&&data.length>0){
