                                ...
                                <div class="col-lg-2 form-group">
                                    ...
                                    <select id="epidemicNameSelect" class="form-control AQForm">
                                        <c:forEach items="${oieDiseasesEntityList}" var="oieDiseasesEntity">
                                            <option value="${oieDiseasesEntity.id}">${oieDiseasesEntity.diseaseNameCn}</option>
                                        </c:forEach>
                                    </select>
                                </div>
...
<script type="text/javascript">
    ...
    function initChart(data1, selectObj) {
        ...
        var firstLocation = "";
        var lastLocation = "";
        if(data1&&data1['pathAndValueResult']&&data1['pathAndValueResult'].length>0){
        ...
        var option = {
            ...
            title: {
                text: $("#epidemicNameSelect option:selected").text(),
                subtext: '',
                x: 'center',
                textStyle: {
                    color: '#fff'
            ...
            series: [
                ...
                {
                    name: $("#epidemicNameSelect option:selected").text(),
                    type: 'map',
                    mapType: 'world',
                    data: [],
                    markLine: {
    ...
    function search() {
        var epidemicName = $("#epidemicName").val();
        var pMap = {};
        pMap['disease'] = $("#epidemicNameSelect option:selected").text();
