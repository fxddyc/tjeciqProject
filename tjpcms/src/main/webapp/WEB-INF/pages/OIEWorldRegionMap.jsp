...
<script>
    var placeList = [
        {name:'United Kingdom',geoCoord:[-3.435973,55.378051]},
        {name:'china',geoCoord:[104.195397,35.86166]}
    ];
...
//                    },
                    ...
                    data : [
                        {name : 'Russia', value : 10,content:"2017-06-13 俄罗斯 发生 A类 牛结节性皮肤病 1次 "},
                        {name : 'Netherlands', value : 1,content:"adfasdfas"},
                        {name : 'Luxembourg', value : 1,content:"adfasdfas"},
                        {name : 'China', value : 7,content:"adfasdfas"},
                        {name : 'Ivory Coast', value : 4},
                        {name : 'Cameroon', value : 4},
                        {name : 'Democratic Republic of the Congo', value : 1},
                        {name : 'Republic of the Congo', value : 1},
    ...
    function findWorldMap() {
        $.post("/wordRegion/wordRegion.do", {
                'epidemicName': $('#epidemic').val(),
