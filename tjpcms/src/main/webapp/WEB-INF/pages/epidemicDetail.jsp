                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="blog-post">
                                ...
                                <ul>
                                    <li><a href="javascript:;"><i class="  fa fa-comments-o"></i> admin on Vestiblulum
                                        quis
                                        dolor </a></li>
                                    <li><a href="javascript:;"><i class="  fa fa-comments-o"></i> admin on Nam sed arcu
                                        tellus</a></li>
                                    <li><a href="javascript:;"><i class="  fa fa-comments-o"></i> monster002 on
                                        Fringilla ut
                                        vel
                                        ipsum </a></li>
                                    <li><a href="javascript:;"><i class="  fa fa-comments-o"></i> admin on Vestiblulum
                        ...
                        <div class="panel-body">
                            <div class="blog-post">
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:;"><i class="  fa fa-angle-right"></i> February 2013</a>
                                    </li>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="media blog-cmnt">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="media blog-cmnt">
                                                <a href="javascript:;" class="pull-left">
                                                    <img alt="" src="images/blog/blog-avatar-2.jpg"
                                                         class="media-object-child">
                                                </a>
                                                <div class="media-body">
                                                    <h4 class="media-heading">
                                                        <a href="#">jones</a>
                                                    ...
                                                    <div class="media blog-cmnt">
                                                        <a href="javascript:;" class="pull-left">
                                                            <img alt="" src="images/blog/blog-avatar.jpg"
                                                                 class="media-object-child">
                                                        </a>
                                                        <div class="media-body">
                                                            <h4 class="media-heading">
                                                            ...
                                                            <div class="media blog-cmnt">
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <div class="media blog-cmnt">
                                                                        <a href="javascript:;" class="pull-left">
                                                                            <img alt=""
                                                                                 src="images/blog/blog-avatar.jpg"
                                                                                 class="media-object-child">
                                                                        </a>
                                                                        <div class="media-body">
                                                                            <h4 class="media-heading">
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" class="form-horizontal leave-cmnt">
                                        ...
                                        <p>
                                            <button class="btn btn-post-cmnt pull-right" type="submit">Post Comment
                                            </button>
                                        </p>
                                    </form>
                                </div>
