...
public class WeeklyReportExportController {
    ...
    public void findRecentOutbreakRegion(String startDateCondition, String svgString, String svgDiseaseDetailBar, String svgDiseaseHistoryBar,
                                         String svgReportReasonPie, HttpServletResponse response, HttpServletRequest request) throws Exception {
        String startDate;
        String endDate;
        Date date = new Date();
        ...
        StringBuilder fileName = new StringBuilder("疫情周报(").append(startDate).append("至").append(endDate).append(").docx");
        byte[] bytes;
        ...
        try {
            ...
            bytes = weeklyReportExportService.buildWordDoc(startDateCondition,svgString,svgDiseaseDetailBar,svgDiseaseHistoryBar,svgReportReasonPie);
    ...
    public void findDiseaseClassData(String startDateCondition,HttpServletResponse response) throws Exception {
        response.getOutputStream().write(weeklyReportExportService.findDiseaseClassData(startDateCondition).getBytes("utf-8"));
    }
    ...
    public void findDiseaseDetailData(String startDateCondition,HttpServletResponse response) throws Exception {
        response.getOutputStream().write(weeklyReportExportService.findDiseaseDetailData(startDateCondition).getBytes("utf-8"));
    }

    @RequestMapping("findContinentDiseaseHistoryData")
    public void findContinentDiseaseHistoryData(String startDateCondition,HttpServletResponse response) throws Exception {
        response.getOutputStream().write(weeklyReportExportService.findDiseaseHistoryData(startDateCondition).getBytes("utf-8"));
    }
    ...
    public void findReportReasonData(String startDateCondition,HttpServletResponse response) throws Exception {
        response.getOutputStream().write(weeklyReportExportService.findReportReasonData(startDateCondition).getBytes("utf-8"));
    }
