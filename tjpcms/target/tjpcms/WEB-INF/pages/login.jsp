...
<div class="container">
    ...
    <form class="form-signin" action="${pageContext.request.contextPath}/system/loginVilidate.do" method="post">
        <div class="form-signin-heading text-center">
            <h1 class="sign-title">天津检疫局疫情监测平台</h1>
            <img src="${pageContext.request.contextPath}/adminex/images/login-logo.png" alt=""/>
        </div>
        <div class="login-wrap">
            <input type="text" name="userId" class="form-control" placeholder="请输入您的用户名..." value=""
                   autofocus>
            <input type="password" name="passWd" class="form-control" placeholder="请输入您的密码...">
